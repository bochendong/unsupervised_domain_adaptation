...
if __name__ == '__main__':
    ...
    # data parameters
    parser.add_argument('--dataset', default='MNIST', help='cifar10 | imagenet')
    ...
    #--------------------------------------------------------------------------
    net = model.load(args.model_file)
...
'''python plot_surface.py --x=-1:1:51 --model vgg9 --model_file ../model_history/VGG9/model_10.t7 --cuda --dir_type states --xnorm filter --xignore biasbn'''